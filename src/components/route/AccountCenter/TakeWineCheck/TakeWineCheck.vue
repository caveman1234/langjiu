<template>
    <div class="TakeWineCheck">
        <SearchComp ref="searchRef" :searchConfig="searchConfig" serverUrl="/ocm-web/api/b2b/query-balance/queryBorrowWineDetail" @receiveData="receiveData" :disable11="true"></SearchComp>
