<template>
    <div class="FinatialCheck">
        <SearchComp ref="searchRef" :searchConfig="searchConfig" serverUrl="/ocm-web/api/b2b/query-balance/queryFinancingDetail" @receiveData="receiveData" :disable11="true"></SearchComp>
