<template>
    <div class="WaitAuditCheck">
        <SearchComp 
            :canExport="true"
            exportUrl="/ocm-web/api/unApproveChargeDetailExport-excel/excelDataExport"
            ref="searchRef" 
            :searchConfig="searchConfig" 
            @receiveData="receiveData" 
            serverUrl="/ocm-web/api/b2b/query-balance/queryUnApproveCharge">
        </SearchComp>
            ...
            <el-table :data="tableData" border>
                ...
                <el-table-column prop="dbilldate" label="单据日期">
                    <template slot-scope="scope">
                        <div>
                            <div>{{scope.row.dbilldate|formatDate}}</div>
                        </div>
                    </template>
                </el-table-column>
                <el-table-column prop="syb" label="事业部名称"></el-table-column>
                ...
                <el-table-column prop="lmsname" label="联盟商名称"></el-table-column>
