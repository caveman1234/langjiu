        ...
        $(function () {
            ...
            $("#chat-pannel").on("click", ".list .list-item", function () {
                ...
                if (flag.length) {  //激活已存在的标签
                    ...
                    var trueHtml = EJSObj.e_templateHtml("left_menu.ejs", window.isServer ? "/terminal/static/chat/template/left_menu.ejs" : "/static/chat/template/left_menu.ejs", { data: obj });
                    ...
                    $("#chat-dialog .chat-content>div").removeClass("chat-dy_show");
                    var trueHtml = EJSObj.e_templateHtml("webim_chat_template.ejs", window.isServer ? "/terminal/static/chat/template/webim_chat_template.ejs" : "/static/chat/template/webim_chat_template.ejs", { data: obj });
